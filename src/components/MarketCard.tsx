...
export function MarketCard({ pair }: MarketCardProps) {
  const { data: signals, isLoading } = useSignals(pair);
  ...
  return (
    <div className="bg-slate-900 rounded-xl p-6 border border-slate-800">
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="text-lg font-semibold text-slate-200">{pair}</h3>
